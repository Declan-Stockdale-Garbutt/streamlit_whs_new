...
def find_column_with_more_unique_words(text1, text2):
    # Sometimes main text has title repeated, wile another col has proper text.
...
st.write(' The newsapi pakage is sued to scrape various nws articles from a variety of major news outlets over the web.')
st.write(' The Free model used for this prototype is limited to the first ~200 characters.')
st.write(' As this is a proof of concept, we only aim to prove the potentail usage of this functionality.')
