...
st.header('Search through complex model for topics with similar words')
...
if "df_working" not in st.session_state:
    st.subheader('Please upload a json file in the previous page before proceeding with Complex model')

if 'complex_model' not in st.session_state: # could change to elif?
