...
st.subheader('This page takes a keyword and returns the top 10 most similar documents for that keyword.')
st.write("The displayed output is the title, the text, and a  ~ 100 word summarisation which can be downlaoded")
...
if 'top2vec_model' not in st.session_state or st.session_state.top2vec_model == False:
    ...
    st.subheader('Please run Simple model first to see results')
